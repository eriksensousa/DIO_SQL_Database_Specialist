...
insert into clientes (nome_cliente, CPF, modelo_do_veiculo, Placa_do_veiculo,contato_cliete) values
						('Renato Abraao', '44222334785','etios','FLF5j33','960813116'),
                        ('Eduardo Esteves', '38822334785','corsa','ALF5G44','960813469'),
                        ('Alberto Torres', '24222334385','Palio','ABF5j21','980813174');
...
insert into equipe_de_mecanicos (nome_mecanico,endereço,especialidade_mecanica) values
								('Tarcisio Mello', 'Rua francisco 82','Funilaria'),
                                ('Joatao Souza', 'Rua Ribas 63', 'Motor'),
                                ('Renan Pinheiros','Rua Barão silva 22', 'Eletrica');
